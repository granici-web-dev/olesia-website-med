...
/** Free 15-min orientation call — helps the visitor pick the right service. */
      ...
      <div className="shell flex flex-col gap-8 py-16 md:flex-row md:items-center md:justify-between md:py-20">
        <div className="max-w-[44ch]">
          ...
          <h2 className="serif mt-3 text-[clamp(1.8rem,3.5vw,2.6rem)] leading-[1.1] tracking-[-0.01em]">
            {t('15 minute gratuite', '15 free minutes')}
          </h2>
        ...
        <div className="flex shrink-0 flex-wrap items-center gap-4">
          <Link
            href={`/${locale}/contact`}
            className="inline-flex items-center rounded-full bg-cream px-6 py-3 text-sm font-semibold text-sage-deep transition-transform hover:-translate-y-0.5"
          >
            {t('Programează discuția', 'Book the call')}
          </Link>
          <a
