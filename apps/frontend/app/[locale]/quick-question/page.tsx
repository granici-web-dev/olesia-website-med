...
const STEPS: { title: Bi; text: Bi }[] = [
  ...
  {
    title: {
      ro: 'Medicul analizează',
      en: 'The doctor reviews',
      ru: 'Врач изучает',
    },
    text: {
...
const GET: Bi[] = [
  {
    ro: 'Analiza informațiilor și a documentelor trimise',
    en: 'Review of the information and documents you send',
    ru: 'Разбор присланной информации и документов',
  },
  {
    ro: 'Un răspuns scris și personalizat în {slaInHours}',
    en: 'A written, personalized answer within {slaInHours}',
    ru: 'Письменный, персональный ответ за {slaInHours}',
  },
  {
    ro: 'Recomandări orientative privind conduita ulterioară',
    en: 'Guidance on the next steps to take',
    ru: 'Ориентировочные рекомендации по дальнейшим действиям',
  },
  {
    ro: 'Recomandarea unor investigații suplimentare sau a unei consultații complete, dacă e nevoie',
    en: 'A suggestion for further tests or a full consultation, if needed',
    ru: 'Рекомендация дополнительных обследований или полной консультации, если нужно',
  },
  {
    ro: 'O rundă de clarificări',
    en: 'One round of clarification',
    ru: 'Возможность один раз задать уточняющие вопросы',
  },
];
...
const EXAMPLES: Bi[] = [
  {
    ro: 'Interpretarea unei analize sau a unor rezultate de laborator',
    en: 'Interpreting a test or lab results',
    ru: 'Интерпретация анализа или результатов лабораторных исследований',
  },
  {
    ro: 'Recomandări privind alimentația copilului sau a adultului',
    en: 'Advice on a child’s or adult’s nutrition',
    ru: 'Рекомендации по питанию ребёнка или взрослого',
  },
  {
    ro: 'O întrebare din alimentația complementară la sugari',
    en: 'A question about complementary feeding for infants',
    ru: 'Вопрос по введению прикорма у грудничков',
  },
  {
    ro: 'Administrarea vitaminelor, mineralelor sau a suplimentelor',
    en: 'Taking vitamins, minerals, or supplements',
    ru: 'Приём витаминов, минералов или добавок',
  },
  {
    ro: 'Clarificarea unei recomandări medicale primite anterior',
    en: 'Clarifying a medical recommendation you received',
    ru: 'Уточнение ранее полученной медицинской рекомендации',
  },
  {
    ro: 'O a doua opinie privind un diagnostic sau un plan de tratament',
    en: 'A second opinion on a diagnosis or treatment plan',
    ru: 'Второе мнение по диагнозу или плану лечения',
  },
  {
    ro: 'O situație pediatrică frecventă (febră, mușcătură de insectă, vomă, diaree)',
    en: 'A common pediatric situation (fever, insect bite, vomiting, diarrhea)',
    ru: 'Частая педиатрическая ситуация (температура, укус насекомого, рвота, диарея)',
  },
  {
    ro: 'Orientare privind investigațiile sau pașii următori',
    en: 'Guidance on tests or the next steps',
    ru: 'Ориентир по обследованиям или дальнейшим шагам',
  },
];
...
const FAQ: { q: Bi; a: Bi }[] = [
  {
    q: {
      ro: 'Cât de repede primesc răspunsul?',
      en: 'How fast do I get the answer?',
      ru: 'Как быстро я получу ответ?',
    },
    a: {
  ...
  {
    q: {
      ro: 'Pot atașa poze sau documente?',
      en: 'Can I attach photos or documents?',
      ru: 'Можно ли приложить фото или документы?',
    },
    a: {
  ...
  {
    q: {
      ro: 'Pot pune întrebări suplimentare?',
      en: 'Can I ask follow-up questions?',
      ru: 'Можно ли задать дополнительные вопросы?',
    },
    a: {
      ro: 'Da, este inclusă o rundă de clarificări.',
      en: 'Yes — one round of clarification is included.',
      ru: 'Да, один раз уточнить можно.',
    },
  },
  {
    q: {
      ro: 'Este pentru urgențe?',
      en: 'Is it for emergencies?',
      ru: 'Это для экстренных случаев?',
    },
    a: {
  ...
  {
    q: {
      ro: 'În ce limbi pot scrie?',
      en: 'Which languages can I write in?',
      ru: 'На каких языках можно писать?',
    },
    a: {
      ...
      <section className="border-b border-[var(--rule)]">
        <div className="shell py-20 md:py-28">
          <p className="mb-10 inline-flex items-center gap-2.5 text-[11px] font-medium uppercase tracking-[0.16em] text-ink-soft">
            ...
            />
            {ru
              ? 'Экспресс-вопрос · Онлайн-портал'
              : en
                ? 'Express question · Online portal'
                : 'Întrebare EXPRESS · Portal online'}
          </p>
          <div className="grid items-start gap-10 md:grid-cols-[1.15fr_0.85fr] md:gap-14 lg:gap-20">
            <div>
              <h1 className="serif max-w-[16ch] text-[clamp(2.4rem,5.4vw,4.8rem)] leading-[1.05] tracking-[-0.015em] text-balance">
                {ru ? (
                  <>
                    Один вопрос,{' '}
                    <span className="serif-it text-sage">ответ</span> за {sla}
                  </>
                ) : en ? (
                  <>
                    One question, an{' '}
                    <span className="serif-it text-sage">answer</span> in {sla}
                  </>
                ) : (
                  <>
                    O întrebare, un{' '}
                    <span className="serif-it text-sage">răspuns</span> în {sla}
                  </>
                )}
              </h1>
            ...
            <div className="md:border-l md:border-[var(--rule)] md:pl-12 lg:pl-16">
              <p className="mono inline-flex items-center rounded-full border border-[var(--rule)] px-3.5 py-1.5 text-[11px] uppercase tracking-[0.12em] text-ink-soft">
                {ru
                  ? `Онлайн-портал · ответ за ${sla}`
                  : en
                    ? `Online portal · ${sla} reply`
                    : `Portal online · răspuns în ${sla}`}
              </p>
      ...
      <section className="shell grid gap-12 py-20 md:grid-cols-[1.1fr_0.9fr] md:gap-20 md:py-28">
        <div>
          <p className="eyebrow mb-3">
            {ru ? 'Что вы получаете' : en ? 'What you get' : 'Ce primești'}
          </p>
          <h2 className="serif text-[clamp(1.9rem,3.4vw,2.8rem)] leading-[1.05] tracking-[-0.02em] text-balance">
            {ru ? (
              <>
                Ясный, письменный{' '}
                <span className="serif-it text-sage">ответ</span>
              </>
            ) : en ? (
              <>
                A clear, written{' '}
                <span className="serif-it text-sage">answer</span>
              </>
            ) : (
              <>
                Un răspuns clar, în{' '}
                <span className="serif-it text-sage">scris</span>
              </>
            )}
          </h2>
        ...
        <div className="md:pt-12">
          <p className="eyebrow mb-3">
            {ru ? 'Когда подходит' : en ? 'Best for' : 'Pentru ce e potrivită'}
          </p>
          ...
          <div className="max-w-[40rem]">
            ...
            <h2 className="serif text-[clamp(1.9rem,3.4vw,2.8rem)] leading-[1.05] tracking-[-0.02em] text-balance">
              {ru ? (
                ...
                <>
                  Exemple de{' '}
                  <span className="serif-it text-sage">întrebări</span>
                </>
              )}
            </h2>
          </div>
        ...
        <div className="shell grid gap-10 py-16 md:grid-cols-2 md:gap-20 md:py-20">
          ...
          <div>
            ...
            <p className="max-w-[56ch] leading-relaxed text-ink-soft text-pretty">
              {ru ? (
                <>
                  Экспресс-вопрос — не для экстренных случаев. Если ситуация
                  экстренная или быстро ухудшается, звоните{' '}
                  <span className="font-medium text-ink">112</span> или
                  обращайтесь в ближайшую службу неотложной помощи.
                </>
              ) : en ? (
                <>
                  Express question isn’t for emergencies. If the situation is
                  urgent or worsening fast, call{' '}
                  <span className="font-medium text-ink">112</span> or go to the
                  nearest emergency service.
                </>
              ) : (
                <>
                  Întrebarea EXPRESS nu este pentru urgențe. Dacă situația e
                  urgentă sau se agravează rapid, sună la{' '}
                  <span className="font-medium text-ink">112</span> sau mergi la
            ...
            <div className="max-w-[38rem]">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-4">
                ...
                <span className="text-sm text-[var(--sage-soft)]">
                  {ru
                    ? 'Нужно больше, чем вопрос? '
                    : en
                      ? 'Need more than a question? '
              ...
              <ul className="grid gap-3 text-[1.05rem]">
                ...
                <li>
                  <Link href="/nutrition" className={creamUnderline}>
                    {ru
                      ? 'Питание или диета? → Консультация по нутрициологии'
                      : en
                        ? 'Feeding or diet? → Nutrition consultation'
                        : 'Alimentație sau dietă? → Consultație de nutriție'}
                  </Link>
                </li>
                <li>
                  <Link href="/integrative" className={creamUnderline}>
                    {ru
                      ? 'Сложный случай? → Интегративная консультация'
                      : en
                        ? 'A complex case? → Integrative consultation'
                        : 'Un caz complex? → Consultație integrativă'}
                  </Link>
                </li>
              </ul>
            </div>
