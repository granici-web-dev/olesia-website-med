...
export default async function MenusPage({
  ...
  const meta = (days: number) =>
    `${days} ${en ? 'days' : 'zile'} · ${en ? 'View on page' : 'Vezi pe pagină'} · RO`;
    ...
    <main className="bg-cream text-ink">
            ...
            <div>
              ...
              <div className="mt-9 flex flex-wrap items-center gap-x-7 gap-y-4">
                <a href="#library" className={btnDark}>
                  {en ? 'Browse the menus' : 'Vezi meniurile'}
                </a>
      ...
      <section id="library" className="scroll-mt-24 shell py-20 md:py-28">
        <header className="mb-8 flex flex-col gap-4 md:flex-row md:items-baseline md:justify-between">
          <div>
            <p className="eyebrow mb-3">{en ? 'Choose by age' : 'Alege în funcție de vârstă'}</p>
        ...
        <MenuLibrary
          ...
          labels={{
            all: en ? 'All' : 'Toate',
            view: en ? 'View menu' : 'Vezi meniul',
            emptyTitle: en ? 'Menus are coming soon' : 'Meniurile vin în curând',
            emptyBody: en
            ...
            emptyCta: en ? 'Nutrition consultation' : 'Consultație de nutriție',
      ...
      <section className="bg-paper">
        <div className="shell grid gap-12 py-20 md:grid-cols-2 md:gap-20 md:py-24">
          <div>
            <p className="eyebrow mb-3">{en ? 'How to use them' : 'Cum să folosești meniurile'}</p>
        ...
        <div className="shell grid gap-10 py-20 md:grid-cols-[1.1fr_0.9fr] md:gap-16 md:py-24">
          <div>
            <p className="mb-3 text-[11px] font-medium uppercase tracking-[0.16em] text-[var(--sage-soft)]">
              {en ? 'Generic vs personalized' : 'General vs personalizat'}
            </p>
          ...
          <div className="md:border-l md:border-[rgba(245,241,234,0.18)] md:pl-12 lg:pl-16">
            <p className="mb-4 text-[11px] font-medium uppercase tracking-[0.16em] text-[var(--sage-soft)]">
              {en ? 'A personalized plan covers' : 'Un plan personalizat acoperă'}
            </p>
            <ul className="grid gap-3">
              {[
                { ro: 'Alergii și intoleranțe', en: 'Allergies and intolerances' },
                { ro: 'Dificultăți de hrănire', en: 'Feeding difficulties' },
                { ro: 'Gramaje și porții adaptate', en: 'Tailored amounts and portions' },
                { ro: 'O afecțiune sau o nevoie specifică', en: 'A condition or specific need' },
              ].map((it) => (
                <li
                  key={it.en}
      ...
      <section className="shell grid gap-12 border-b border-[var(--rule)] py-20 md:grid-cols-2 md:gap-20 md:py-24">
        <div>
          <p className="eyebrow mb-3">{en ? 'Safety' : 'Siguranță'}</p>
          <p className="max-w-[52ch] leading-relaxed text-ink-soft text-pretty">
            {en
        ...
        <div className="md:border-l md:border-[var(--rule)] md:pl-12 lg:pl-16">
          <p className="eyebrow mb-3">{en ? 'Who prepares them' : 'Cine pregătește meniurile'}</p>
