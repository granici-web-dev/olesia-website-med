...
export const MATERIAL_CATEGORIES: SeedMaterialCategory[] = [
  { slug: 'pediatrie', nameRo: 'Pediatrie', nameEn: 'Pediatrics', nameRu: 'Педиатрия' },
  { slug: 'urgente', nameRo: 'Urgențe și prim ajutor', nameEn: 'Emergencies & first aid', nameRu: 'Неотложная помощь' },
  { slug: 'nutritie-copii', nameRo: 'Nutriție copii', nameEn: 'Child nutrition', nameRu: 'Питание детей' },
  { slug: 'nutritie-adulti', nameRo: 'Nutriție adolescenți și adulți', nameEn: 'Teen & adult nutrition', nameRu: 'Питание подростков и взрослых' },
  { slug: 'diversificare', nameRo: 'Alimentație complementară', nameEn: 'Complementary feeding', nameRu: 'Прикорм' },
  { slug: 'alergii', nameRo: 'Alergii și intoleranțe', nameEn: 'Allergies & intolerances', nameRu: 'Аллергии и непереносимости' },
  { slug: 'dezvoltare', nameRo: 'Dezvoltarea copilului', nameEn: 'Child development', nameRu: 'Развитие ребёнка' },
  { slug: 'parenting', nameRo: 'Sănătate emoțională și parenting', nameEn: 'Emotional health & parenting', nameRu: 'Эмоциональное здоровье и воспитание' },
  { slug: 'checklist', nameRo: 'Ghiduri practice și checklist-uri', nameEn: 'Practical guides & checklists', nameRu: 'Практичные гайды и чек-листы' },
];
...
export const MATERIALS: SeedMaterial[] = [
  {
    ...
    descriptionRo: 'Când și cum începi diversificarea, în siguranță și fără stres.',
  ...
  },
  {
    ...
    descriptionRo: 'Idei de mese pe zile pentru începutul diversificării autocondusă.',
  ...
  },
  {
    ...
    descriptionRo: 'Strategii practice pentru mesele dificile și refuzul mâncării.',
    descriptionEn: 'Practical strategies for hard meals and food refusal.',
    descriptionRu: 'Практичные стратегии для сложных приёмов пищи и отказа от еды.',
    pageCount: 12,
    access: 'free',
    price: null,
    flags: ['popular'],
  },
  {
    ...
    descriptionRo: 'Cum compui mese echilibrate pentru copilul de vârstă școlară.',
  ...
  },
  {
    ...
    descriptionRo: 'Nevoile nutriționale în adolescență și capcanele frecvente.',
    descriptionEn: 'Nutritional needs in adolescence and common pitfalls.',
    descriptionRu: 'Потребности в питании в подростковом возрасте и частые ошибки.',
    pageCount: 18,
    access: 'free',
    price: null,
    flags: [],
  },
  {
    ...
    descriptionRo: 'Ce e normal, când să te îngrijorezi și cum susții imunitatea.',
    descriptionEn: 'What\'s normal, when to worry, and how to support immunity.',
    descriptionRu: 'Что нормально, когда стоит беспокоиться и как поддержать иммунитет.',
    pageCount: 14,
    access: 'free',
    price: null,
    flags: ['recommended'],
  },
  {
    ...
    descriptionEn: 'The essential list and what to do in the first minutes of an emergency.',
    descriptionRu: 'Список необходимого и что делать в первые минуты при неотложной ситуации.',
    pageCount: 8,
    access: 'free',
    price: null,
    flags: ['new'],
  },
  {
    ...
    descriptionRo: 'Cum măsori corect, când dai antitermice și când suni medicul.',
    descriptionEn: 'How to measure correctly, when to give antipyretics, when to call the doctor.',
    descriptionRu: 'Как правильно измерять, когда давать жаропонижающее и когда звонить врачу.',
    pageCount: 10,
    access: 'paid',
    price: 7,
    flags: ['popular'],
  ...
  },
  {
    ...
    descriptionRu: 'Спокойные ритуалы и эмоциональная поддержка для более лёгких дней.',
    pageCount: 12,
    access: 'paid',
    price: 9,
    flags: [],
  },
  {
    ...
    descriptionRo: 'Ce pregătești și ce întrebări notezi înainte de consultație.',
    descriptionEn: 'What to prepare and which questions to note before the consultation.',
    descriptionRu: 'Что подготовить и какие вопросы записать перед консультацией.',
    pageCount: 4,
    access: 'free',
    price: null,
    flags: ['new'],
