...
function SheetContent({
  ...
  return (
    <SheetPrimitive.Portal>
      ...
      >
        {children}
        <SheetPrimitive.Close className="absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus-visible:ring-[3px] focus-visible:ring-ring/40 outline-none disabled:pointer-events-none">
