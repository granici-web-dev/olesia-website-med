...
export * from '@/features/users/mock';
...
export const setUserActive = USE_MOCKS ? mock.setUserActive : remote.setUserActive;
export const resetPassword = USE_MOCKS ? mock.resetPassword : remote.resetPassword;
