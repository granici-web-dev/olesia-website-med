...
export const fetchContacts = USE_MOCKS
  ? mock.fetchContacts
  : remote.fetchContacts;
export const createContact = USE_MOCKS
  ? mock.createContact
  : remote.createContact;
export const updateContact = USE_MOCKS
  ? mock.updateContact
  : remote.updateContact;
export const deleteContact = USE_MOCKS
  ? mock.deleteContact
  : remote.deleteContact;
