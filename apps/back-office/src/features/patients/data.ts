...
export const fetchPatients = USE_MOCKS
  ? mock.fetchPatients
  : remote.fetchPatients;
export const fetchPatient = USE_MOCKS ? mock.fetchPatient : remote.fetchPatient;
export const fetchTimeline = USE_MOCKS
  ? mock.fetchTimeline
  : remote.fetchTimeline;
export const createPatient = USE_MOCKS
  ? mock.createPatient
  : remote.createPatient;
export const updatePatient = USE_MOCKS
  ? mock.updatePatient
  : remote.updatePatient;
export const deletePatient = USE_MOCKS
  ? mock.deletePatient
  : remote.deletePatient;
