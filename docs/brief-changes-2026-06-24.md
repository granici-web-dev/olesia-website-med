...
- **New back-office modules** (§11.12) — ~~FAQ~~, ~~testimonials~~ (both ✅ 2026-07-28), media appearances, PDF materials, site media (hero video + portraits). The rest do not exist yet.
...
**Missing for her list:** ~~FAQ~~ · ~~testimonials~~ (both ✅ 2026-07-28) · media appearances · PDF materials (Biblioteca) · site media (hero video + portraits) — plus the already-planned data-driven catalog for prices/texts.
...
**Localisation gap:** ✅ **CLOSED 2026-07-27** for every model that exists today — services, blog (posts + categories), contacts and About (title/content + all four JSON blocks) now carry `*Ru`, editable from a third language tab/column in the back office. The modules that do not exist yet (media appearances, materials, site media) must be **born trilingual** — RO/EN required, RU optional with a RO fallback, same as the rest. The FAQ module (✅ 2026-07-28) was the first built to that rule.
